 ...
 */
@WebServlet(name = "dept_insert", urlPatterns = { "/mvc/dept/insert.do" })
public class MvcDeptInsertServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd= request.getRequestDispatcher("/deptview/mvc_insertResult.jsp");
