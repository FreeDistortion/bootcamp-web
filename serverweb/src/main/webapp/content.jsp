...
<body>
	...
	<h4>
		...
		if (member != null) {
		%>
		<small>즐거운 web,<%= member.getName() %></small>
		----------EL(express language)로 출력하기: ${loginmember.name }----------
		<%
		} else {
		%>
		<small>즐거운 web</small>
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active">
					<img src="/serverweb/images/m_garden01.jpg" alt="Image" width="800"
						height="320">
				...
				<div class="item">
					<img src="/serverweb/images/m_garden02.jpg" alt="Image" width="800"
						height="320">
					<div class="carousel-caption">
						<h3>다음주는 고급진 웹...</h3>
						<p>Open API, Ajax..</p>
